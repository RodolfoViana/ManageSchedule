...
public class TestaTelefonesDeContato {
	...
	public void test2() throws Exception{
		telefone = new TelefonesDeContato("", "(83)3333-9999", "(83)88007777");
	}
	
	@Before
	public void test3() throws Exception{
		telefone = new TelefonesDeContato("(83)3322-1010", "", "");
	}	
	...
	public void testaTelefoneResidencial(){
		...
		try{
			telefone = new TelefonesDeContato("(83)3-1010", "(83)3333-9999", "(83)8800-7777");
		...
		try{
			telefone = new TelefonesDeContato("(8)3322-1010", "(83)3333-9999", "(83)8800-7777");
			Assert.fail("Esperava excecao de telefone residencial invalido");
		}catch(Exception e){
			Assert.assertEquals("Telefone residencial invalido", e.getMessage());
		}
		...
		try{
			telefone = new TelefonesDeContato("(83)3322-101", "(83)3333-9999", "(83)8800-7777");
			Assert.fail("Esperava excecao de telefone residencial invalido");
		}catch(Exception e){
			Assert.assertEquals("Telefone residencial invalido", e.getMessage());
		}
		...
		try{
			telefone = new TelefonesDeContato("833322-1010", "(83)3333-9999", "(83)8800-7777");
			Assert.fail("Esperava excecao de telefone residencial invalido");
		}catch(Exception e){
			Assert.assertEquals("Telefone residencial invalido", e.getMessage());
		}
		...
		try{
			telefone = new TelefonesDeContato("(83)3322-10101", "(83)3333-9999", "(83)8800-7777");
			Assert.fail("Esperava excecao de telefone residencial invalido");
		}catch(Exception e){
			Assert.assertEquals("Telefone residencial invalido", e.getMessage());
		}
		...
		try{
			telefone = new TelefonesDeContato("(83)33222-1010", "(83)3333-9999", "(83)8800-7777");
			Assert.fail("Esperava excecao de telefone residencial invalido");
		}catch(Exception e){
			Assert.assertEquals("Telefone residencial invalido", e.getMessage());
		}
		...
		try{
			telefone = new TelefonesDeContato("(083)3322-1010", "(83)3333-9999", "(83)8800-7777");
			Assert.fail("Esperava excecao de telefone residencial invalido");
		}catch(Exception e){
			Assert.assertEquals("Telefone residencial invalido", e.getMessage());
		}
	...
	public void testaTelefoneComercial(){
		...
		try{
			telefone = new TelefonesDeContato("(83)3322-1010", "(83)33-9999", "(83)8800-7777");
			Assert.fail("Esperava excecao de telefone residencial invalido");
		}catch(Exception e){
