...
public class TestaSecretaria {
	...
	TelefonesDeContato telefone1, telefone2, telefone3, telefone4, telefone5;
	...
	@Before public void constroiSecretaria() throws Exception {
		...
		telefone1 = new TelefonesDeContato("(11)1111-1111", "(22)2222-2222", "(33)3333-3333");
		telefone2 = new TelefonesDeContato("(44)4444-4444", "(55)5555-5555", "(66)6666-6666");
		telefone3 = new TelefonesDeContato("(77)7777-7777", "(88)8888-8888", "(99)9999-9999");
		telefone4 = new TelefonesDeContato("(10)1010-1010", "(12)1212-1212", "(13)1313-1313");
		telefone5 = new TelefonesDeContato("(14)1414-1414", "(15)1515-1515", "(16)1616-1616");
		...
		paciente1 = new Paciente("Nome do paciente 1", "111.111.111-11", endereco1, telefone1, "01/01/2001", plano, "emailcontato1@gmail.com", "Telefone residencial", "01/01/2000");
		paciente2 = new Paciente("Nome do paciente 2", "222.222.222-22", endereco2, telefone2, "02/02/2002", plano, "emailcontato2@gmail.com", "Telefone residencial", "02/02/2001");
		paciente3 = new Paciente("Nome do paciente 3", "333.333.333-33", endereco3, telefone3, "03/03/2003", plano, "emailcontato3@gmail.com", "Telefone residencial", "03/03/2002");
		paciente4 = new Paciente("Nome do paciente 4", "444.444.444-44", endereco4, telefone4, "04/04/2004", plano, "emailcontato4@gmail.com", "Telefone residencial", "04/04/2003");
		paciente5 = new Paciente("Nome do paciente 5", "555.555.555-55", endereco5, telefone5, "05/05/2005", plano, "emailcontato5@gmail.com", "Telefone residencial", "05/05/2004");
